...
class Controller():
	...
	def logout(self):
		# Log out only after being logged in
		if not self.logged:
   ...
   # Search for a patient by PHN
    ...
    # retrieve patients, search by name or substring of name
	...
	# user retrieves the notes from the current patient's record that satisfy a search string
